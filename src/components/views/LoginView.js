  ...
  return (
    <Container maxWidth={"xs"} sx={{ mt: 6 }}>
      <Stack alignItems="center">
        ...
        Not registered yet?<FontAwesomeIcon style={{marginLeft: '3px', marginRight: '15px'}} icon={faUser}></FontAwesomeIcon>
          <br />
          
          <Link style={{color: 'white'}} to="/signup"> 
          <FontAwesomeIcon style={{marginRight: '10px'}} icon={faRightToBracket}></FontAwesomeIcon>Signup now</Link>
        </Typography>

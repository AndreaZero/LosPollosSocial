  ...
  return (
    <Container>
      ...
      <Box style={{borderRadius: '1rem'}}>
        <Card sx={{ padding: 0, marginBottom: "1.3rem",}}> 
          <Grid
            container
            sx={{ height: "calc(100vh - 110px)",
        
            boxShadow: '0 0 10px 2px #03A9FC'}}
            alignItems="stretch"
          >
            {!mobile ? (
              <>
<Grid
  ...
  xs={5}
  sx={{
    borderRight: '1px solid #03A9FC',
    boxShadow: '0 0 10px 2px #03A9FC', // Questo crea l'effetto "glow" stile neon
    height: "100%"
  }}
>

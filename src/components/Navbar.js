...
const Navbar = () => {
  ...
  const isOg = user && isLoggedIn().isOg;
  ...
  console.log(user.username + isOg);
  ...
  backgroundColor: 'yellow',
        ...
        <HorizontalStack>
          {mobile && (
            ...
            <img style={{width: '50px', objectFit: 'contain'}} src={gas} alt="gas"></img>
            </a>
          ...
          {user ? (
            <>
              ...
              <Button style={{color: 'black', backgroundColor: 'yellow', padding: '5px', boxShadow: "0px 0px 3px 0px black"}}  onClick={handleLogout}>Logout</Button>
            </>
          ) : (
            <>

    ...
    <Card>
      {user ? (
        <Stack alignItems="center" spacing={2}>
          ...
          {currentUser && user._id !== currentUser.userId && (
            <Button style={{color: 'yellow', border: '1px solid yellow',
          ...
          <HorizontalStack>
            <Typography color="white">
              Likes <b style={{color: 'yellow'}}>{props.profile.posts.likeCount}</b>
            </Typography>
            <Typography color="white">
              Posts <b style={{color: 'yellow'}}>{props.profile.posts.count}</b>
            </Typography>
          </HorizontalStack>
        </Stack>
      ) : (

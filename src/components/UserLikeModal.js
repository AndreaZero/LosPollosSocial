...
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
  import { faRightToBracket, faThumbsUp, faUser } from '@fortawesome/free-solid-svg-icons';
      ...
      >
        <Card>
          <Typography variant="h5" mb={2}>
            Chi ha messo like al post <FontAwesomeIcon icon={faThumbsUp}></FontAwesomeIcon>
          </Typography>
          <Stack>
            <Stack spacing={2}>
              {userLikes &&

...
>
  ...
  >
    ...
    >
  {user ? (
    <h3>Welcome {user.username}! <br />Check out the latest posts</h3>
  ) : (
    <h5>Welcome! <br />Check out the latest posts</h5>
  )}
</Typography>
            ...
            <Typography variant="h5" color="white" style={{
              ...
              {posts.length > 0 ? (
                ...
                <>No post available 😔</>
                          ...
                          <Button style={{backgroundColor: "rgb(53,168,245)", color: 'black', fontWeight: "bold"}} onMouseEnter={(e) => {

...
const Messages = (props) => {
  ...
  return props.conservant ? (
      ...
      {messages && conversation && !loading ? (
        <>
          ...
          <Box sx={{ height: "calc(100vh - 240px)", padding: "20px"}}>
            <Box sx={{ backgroundColor: '#dedede', height: "100%", borderRadius: "0.5rem" }}>
              <Stack
    ...
    <Stack
      sx={{ height: "100%", backgroundColor: "#dedede"}}
      justifyContent="center"
      alignItems="center"
      spacing={2}
    >
      <AiFillMessage color='black' size={80} />
      <Typography style={{color: 'black'}} variant="h5">Los Pollos Messenger</Typography>
      <Typography color="black">
        Chatta in privato con altri membri di Los Pollos
      </Typography>
    </Stack>
  );
};

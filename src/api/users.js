...
const getLeaderboard = async () => {
  try {
    const res = await fetch(BASE_URL + "api/users/leaderboard"); // Aggiunta della nuova chiamata
    return res.json();
  } catch (err) {
    console.log(err);
  }
...
export { signup, login, getUser, getRandomUsers, getLeaderboard, updateUser };
